...
if ($id) {
    $sql = "SELECT * FROM labs WHERE id_lab = ?";
...
<body>
    ...
    <ul class="nav flex-column pt-3">
        <li class="nav-item">
            <a class="nav-link " href="index.php">Laboratórios</a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="turma.php">Turmas</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="reserva.php">Reservas</a>
        </li>
        <li class="nav-item">
                        ...
                        <?php if (mysqli_num_rows($resultado) > 0): ?>
                            <div class="table-responsive">
                                <table class="table table-striped table-hover align-middle mb-0">
                                    <thead>
                                        <tr>
                                            <th style="width: 160px;">ID Lab</th>
                                            <th>Número do Lab</th>
                                        </tr>
                                    </thead>
                                    <tbody>
